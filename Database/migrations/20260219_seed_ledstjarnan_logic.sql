...
join (
    values
        ...
        ('ALKOHOL_DROGER','CLIENT','Client rating','Client-reported problem level','CLIENT'),
        ('ALKOHOL_DROGER','STAFF','Staff assessment','Staff clinical assessment','STAFF'),
        ('ALKOHOL_DROGER','M','Motivation','Receptivity/motivation for intervention','STAFF'),
        ('ALKOHOL_DROGER','P','Priority','Priority for treatment planning','STAFF'),
        ('ANKNYTNING_RELATIONER','CLIENT','Client rating','Client-reported problem level','CLIENT'),
        ('ANKNYTNING_RELATIONER','STAFF','Staff assessment','Staff clinical assessment','STAFF'),
        ('ANKNYTNING_RELATIONER','M','Motivation','Receptivity/motivation for intervention','STAFF'),
        ('ANKNYTNING_RELATIONER','P','Priority','Priority for treatment planning','STAFF'),
        ('PSYKISK_OHALSA','CLIENT','Client rating','Client-reported problem level','CLIENT'),
        ('PSYKISK_OHALSA','STAFF','Staff assessment','Staff clinical assessment','STAFF'),
        ('PSYKISK_OHALSA','M','Motivation','Receptivity/motivation for intervention','STAFF'),
        ('PSYKISK_OHALSA','P','Priority','Priority for treatment planning','STAFF'),
        ('ALLVARLIG_PSYKISK_OHALSA','CLIENT','Client rating','Client-reported problem level','CLIENT'),
        ('ALLVARLIG_PSYKISK_OHALSA','STAFF','Staff assessment','Staff clinical assessment','STAFF'),
        ('ALLVARLIG_PSYKISK_OHALSA','M','Motivation','Receptivity/motivation for intervention','STAFF'),
        ('ALLVARLIG_PSYKISK_OHALSA','P','Priority','Priority for treatment planning','STAFF')
